...
async function deleteRestaurantuserreviewpersonalization(restaurantuserreviewpersonalization) {
    ...
    try {
        ...
        let query = await data.query(
            ...
            `
                DELETE FROM restaurantuserreviewpersonalizationsOfRestaurantID_${restaurantuserreviewpersonalization.idFrom}
